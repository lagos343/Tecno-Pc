...
namespace Tecno_Pc.Formularios
{
    public partial class frm_Facturas : Form
    {
        ...
        private async void dgv_Facturas_CellContentClick(object sender_facturas, DataGridViewCellEventArgs index_e)
        {
            if (dgv_Facturas.Rows[index_e.RowIndex].Cells["Mostrar"].Selected)
            {
                ...
                Task tarea_1 = new Task(rep_form.pdf_facturas);
                tarea_1.Start();
                await tarea_1;
        ...
        private void txt_buscar_TextChanged_1(object sender_buscar, EventArgs index_e)
        {
        ...
        private void btn_imprimir_Click(object sender_imprimir, EventArgs index_e)
        {
        ...
        private void btn_sar_Click(object sender_sar, EventArgs index_e)
        {
