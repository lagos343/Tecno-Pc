...
namespace Tecno_Pc.Formularios
{
    public partial class frm_compras : Form
    {
        ...
        private void frm_compras_Load(object sender, EventArgs e)
        {
            ...
            productos.Consultar_Datos(dgv_Productos);
        ...
        private void Operaciones_Datagrid2()//prod que se encarga de ocultar columnas y dar apariencia a el Datagrid de la lista de compras
        {
        ...
        private int buscar_Repetidos(string id) //prod que busca si mandamos una producto que ya estaba en la lista de compras
        {
            int coin = 0; 
        ...
        private void txt_buscar_TextChanged_1(object sender, EventArgs e) //hace busquedas en el datagrid de productos y sirve como filtro para el Escaner de Barras
        {
            if (txt_buscar.Text != "") //verficamos que no este vacio
            {
                ...
                else
                {
                    ...
                    productos.Buscar_Datos(dgv_Productos);
                    Operaciones_Datagrid1();
                }
            }
            else
